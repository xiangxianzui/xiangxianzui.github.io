...
SPARKS.Death.prototype.update = function (emitter, particle, time) {
    if (particle.life <= 0)="" {="" particle.isdead="true;" }="" };="" *="" sparks.move="function()" sparks.move.prototype.update="function(emitter," particle,="" time)="" attempt="" verlet="" velocity="" updating.="" var="" p="particle.position;" v="particle.velocity;" old="particle._oldvelocity;" if="" (this._velocityverlet)="" p.x="" +="(v.x" old.x)="" 0.5="" time;="" p.y="" old.y)="" p.z="" old.z)="" else="" oldvel="Vel;" vel="Vel" accel="" dt;="" pos="Pos" (vel="" dt)="" marks="" particles="" found="" in="" specified="" zone="" dead="" sparks.deathzone="function(zone)" this.zone="zone;" sparks.deathzone.prototype.update="function(emitter," (this.zone.contains(particle.position))="" sparks.actionzone="" applies="" an="" action="" when="" particle="" is="" zone)="" this.action="action;" sparks.actionzone.prototype.update="function(emitter," this.action.update(="" emitter,="" time="" );="" accelerate="" affects="" 3d="" direction="" sparks.accelerate="function(x,y,z)" (x="" instanceof="" three.vector3)="" this.acceleration="x;" return;="" three.vector3(x,y,z);="" sparks.accelerate.prototype.update="function(emitter," acc="this.acceleration;" particle._oldvelocity.set(v.x,="" v.y,="" v.z);="" v.x="" v.y="" v.z="" factor="" based="" on="" a="" of="" particle's="" velocity.="" sparks.acceleratefactor="function(factor)" this.factor="factor;" sparks.acceleratefactor.prototype.update="function(emitter," len="v.length();" adjfactor;="" (len=""> 0) {
